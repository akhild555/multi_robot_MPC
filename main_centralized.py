...
# Simulate Quadrotors
x_cops, x_cop_d, u_cops, x_robber, x_rob_d, u_robber, t = simulate_quadrotor_centralized(x0_cops, x0_robber, quadrotor_central,
...
anim, fig2 = create_animation(x_out, x_d_out, tf, obstacles, num_cops + 1)
